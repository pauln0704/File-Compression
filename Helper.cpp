 ...
 *
 *
 * This file provides the implementations for the wrappers. Note: the template
 * functions are implemented in Helper.tcc.
 * New function added to hpp file is implemented here
 */
...
void FancyInputStream::resetBuffer(){
    buffer = 0;          // clear bitwise buffer
    buffer_index = 8;    // move bitwise buffer index back to beginning
}
